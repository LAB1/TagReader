...
namespace TagReader
{
    public partial class FormTagReader : Form
    {
        ...
        private static KinectDisplay kinectComp;
        private static bool _isKinectOperating = false;
        private static bool _isKinectDisplay = false;
        ...
        private void StartKinect()
        {
            ...
            kinectComp = new KinectDisplay(_isKinectDisplay);
            if (_isKinectDisplay == true)
            {
                kinectComp.Show();
            }
               
            _isKinectOperating = true;
        }
