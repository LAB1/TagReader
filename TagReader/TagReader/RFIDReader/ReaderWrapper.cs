...
namespace TagReader.RFIDReader
{
    public class ReaderWrapper
    {
        ...
        public static void UpdateTagStatus(ref TagStatus currTagStatus)
        {
            ...
            currTagStatus.DopplerShift = currTagStatus.DopplerShift/16;
            currTagStatus.Frequency = ReaderSettings.Channal2Frequency(currTagStatus.ChannelIndex);
        }
        ...
        public static void AppendRowToDatatable(ref TagStatus reportedTagStatus)
        {
            ...
            row["TS"] = (DateTime.Now - DateTime.Parse("1/1/1970 0:0:0")).TotalMilliseconds.ToString();
