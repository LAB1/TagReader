...
namespace TagReader
{
    public partial class SettingsWindow : Form
    {
        ...
        public static bool IsAutoSaveChecked = true;
        ...
        private void checkBox_AutoSave_CheckedChanged(object sender, EventArgs e)
        {
            ...
            textBox_SavedFilePath.Enabled = checkBox_AutoSave.Checked;
            button_SelectFilePath.Enabled = checkBox_AutoSave.Checked;
        }
